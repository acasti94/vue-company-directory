...
.card {
    @apply cursor-pointer overflow-hidden rounded-md bg-slate-100 shadow-md hover:scale-110 transition-transform duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-slate-900;
    &-image{
        img{
    ...
    &-details{
        ...
        &-quote{
            @apply italic text-slate-800 font-semibold;
        }
    }
}
</style>